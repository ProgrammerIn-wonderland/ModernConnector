...
// command
    ...
    String currentMenu;
    TextField wsurl = new TextField("Websocket URL (host:port)", "192.168.1.38:8001", 50, 0);
...
//      menu.append("Test Form", null);
   ...
   public void testForm() {
        ...
        String reply = "";
        try {
               String fullURL =  wsurl.getString();
               ws = new WebSocketClient(fullURL.substring(0, fullURL.lastIndexOf(':')), Integer.parseInt(fullURL.substring(fullURL.lastIndexOf(':') +1, fullURL.length())));
               ws.connectTLS();
